...
const manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/login\.json$/,
      params: empty,
      load: () => import("./index.json-668ad178.js")
    },
    {
      type: "page",
      pattern: /^\/login\/?$/,
    ...
    },
    {
      ...
      pattern: /^\/todos\.json$/,
      params: empty,
      load: () => import("./index.json-288c2c7b.js")
    },
    {
      type: "page",
      pattern: /^\/todos\/?$/,
    ...
    },
    {
      ...
      pattern: /^\/todos\/([^/]+?)\.json$/,
      params: (m) => ({ uid: d(m[1]) }),
      load: () => import("./_uid_.json-095450d2.js")
    },
    {
      type: "page",
      pattern: /^\/game\/?$/,
...
const module_lookup = {
  "src/routes/__layout.svelte": () => import("./__layout-d51a146d.js"),
  ".svelte-kit/build/components/error.svelte": () => import("./error-58b8edbe.js"),
  "src/routes/index.svelte": () => import("./index-b89f7b8c.js"),
  "src/routes/scoreboard/index.svelte": () => import("./index-60c48798.js"),
  "src/routes/Game2.svelte": () => import("./Game2-e63a2628.js"),
  "src/routes/login/index.svelte": () => import("./index-53daa809.js"),
  "src/routes/todos/index.svelte": () => import("./index-c6b095df.js"),
  "src/routes/game/index.svelte": () => import("./index-3ffb745b.js")
};
...
export { add_attribute as a, setContext as b, create_ssr_component as c, safe_not_equal as d, escape as e, each as f, getContext as g, null_to_empty as h, init as i, noop as n, onMount as o, render as r, subscribe as s, validate_component as v };
